...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		options = {
			...
			expire: 7200,				// Minutes to wait before showing the popup again (7200 = 5 days)
		...
		intl = {
			...
			ru_ru: 'Установите это веб-приложение на ваш %device: нажмите %icon, затем <strong>На экран «Домой»</strong>.',
